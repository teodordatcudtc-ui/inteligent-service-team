...
const services = [
  'Service furgonete și autoutilitare',
  'Mentenanță remorci și semiremorci',
  'Schimb ulei și filtre',
  'Sistem frâne și ABS',
  'Suspensie și rulmenți',
  'Pregătire ITP',
  'Reparații generale',
];

export default function ServiciiAutoutilitarePage() {
  return (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div {...fadeUp}>
              ...
              <p className="text-white text-lg max-w-xl">
                Service specializat pentru furgonete, autoutilitare și remorci. Mentenanță,
                reparații și pregătire ITP. Echipa ta de încredere în Timișoara.
              </p>
            </motion.div>
            <motion.div
